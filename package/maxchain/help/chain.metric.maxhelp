...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 532.5, 328.0, 191.0, 20.0 ],
					"style" : "",
					"text" : "print metrichelp @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 687.5, 154.0, 68.0, 20.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-25",
					"items" : [ "mean", ",", "std", ",", "interpolation", ",", "deviation", ",", "max", ",", "min", ",", "median" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 687.5, 187.0, 123.5, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 739.75, 227.0, 83.0, 20.0 ],
					"style" : "",
					"text" : "measure $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 492.0, 41.0, 162.0, 20.0 ],
					"style" : "",
					"text" : "r metrichelp-loadlate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 492.0, 126.0, 104.0, 20.0 ],
					"style" : "",
					"text" : "route metrics"
				}
...
,
					"patching_rect" : [ 492.0, 154.0, 89.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 492.0, 187.0, 133.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 492.0, 72.0, 61.0, 20.0 ],
					"style" : "",
					"text" : "metrics"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 492.0, 98.0, 162.0, 20.0 ],
					"style" : "",
					"text" : "chain.info metrichelp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 532.5, 227.0, 111.0, 20.0 ],
					"style" : "",
					"text" : "metric_name $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 980.5, 221.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 532.5, 277.0, 176.0, 20.0 ],
					"style" : "",
					"text" : "chain.metric metrichelp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.0, 161.0, 39.0, 20.0 ],
					"style" : "",
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 107.0, 161.0, 47.0, 20.0 ],
					"style" : "",
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.5, 424.0, 530.0, 174.0 ],
					"style" : "",
					"text" : "Arguments:\n[chain.metric name]\n    name - optional argument shared by all chain\n           objects which associates each worker object\n           with a chain.site manager.\n\nAttributes:\n    metric_name [s] - name of metric\n    measure [s] - mean, std, deviation, interpolation, max, min, median\n    interp [s] - bilinear\n    pos_x [f]\n    pos_y [f]\n    pos_z [f]\n    radius [f]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 62.0, 221.0, 291.0, 32.0 ],
					"style" : "",
					"text" : "chain.site metrichelp @url http://chain-api.media.mit.edu/sites/7"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.5, 87.0, 463.0, 30.0 ],
					"style" : "",
					"text" : "The chain.metric object is for accessing metadata and data for a specific metric of a chainAPI site accross devices."
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 171.5, 215.5, 71.5, 215.5 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 749.25, 261.5, 542.0, 261.5 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 116.5, 214.5, 71.5, 214.5 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 990.0, 260.5, 542.0, 260.5 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 542.0, 258.5, 542.0, 258.5 ],
					"source" : [ "obj-4", 0 ]
				}
